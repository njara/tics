...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="<?php echo base_url();?>index.php/empresa/logueado">Empresa <span class="sr-only">(current)</span></a></li>
				</ul>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3">
			<form class="form-horizontal" method="post" action="<?php echo base_url() ?>index.php/empresa/editar_perfil">
				<fieldset>
					<legend>Editar Perfil Empresa</legend>
					...
					<div class="form-group">
						<label for="cargo_en_la_empresa" class="col-lg-2 control-label">Cargo</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" name="cargo_en_la_empresa" id="cargo_en_la_empresa" placeholder="Apellido Materno" value="<?php echo $cargo_en_la_empresa;?>">
						</div>
					</div>
					<div class="form-group">
